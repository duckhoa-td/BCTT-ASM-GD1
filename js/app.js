...
const showlistmlb = async () => {
    let arr = await fetch(API_URL + "/mlb")
        ...
        .then(data => data);
    let str = ``; 
    arr.forEach(row => str += show1mlb(row)); return str;
};
const show1mlb = (ml) => {
    return `<div>   <img src="${ml.hinh}">   <h4>${ml.ten}</h4> <p>${Number(ml.gia).toLocaleString("vi")} VNĐ</p>  
    </div> `;
};
...
const showlistvans = async () => {
    let arr = await fetch(API_URL + "/vans")
        ...
        .then(data => data);
    let str = ``; 
    arr.forEach(row => str += show1vans(row)); return str;
};
const show1vans = (v) => {
...
const showlistconverse = async () => {
    let arr = await fetch(API_URL + "/converse")
        ...
        .then(data => data);
    let str = ``; 
    arr.forEach(row => str += show1converse(row)); return str;
};
...
const showlistjordan = async () => {
    let arr = await fetch(API_URL + "/jordan")
        ...
        .then(data => data);
    let str = ``; 
    arr.forEach(row => str += show1jordan(row)); return str;
};
const show1jordan = (j) => {
...
const showlistadidas = async () => {
    let arr = await fetch(API_URL + "/adidas")
        ...
        .then(data => data);
    let str = ``; 
    arr.forEach(row => str += show1adidas(row)); return str;
};
const show1adidas = (a) => {
...
const showlistpuma = async () => {
    let arr = await fetch(API_URL + "/puma")
        ...
        .then(data => data);
    let str = ``; 
    arr.forEach(row => str += show1puma(row)); return str;
};
const show1puma = (p) => {
...
const showlistluxury = async () => {
    let arr = await fetch(API_URL + "/luxury")
        ...
        .then(data => data);
    let str = ``; 
    arr.forEach(row => str += show1luxury(row)); return str;
};
const show1luxury = (l) => {
...
const showlistbalo = async () => {
    let arr = await fetch(API_URL + "/balo")
        ...
        .then(data => data);
    let str = ``; 
    arr.forEach(row => str += show1balo(row)); return str;
};
const show1balo = (b) => {
